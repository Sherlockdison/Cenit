    ...
    <?php require_once "partials/header-nav.php"; ?>
      <div class="faq-container">
        <div class="question-container">
              <ul>
                <li><a href="#question1">¿Cuáles son las formas de pago?</a></li>
                <li><a href="#question2">¿Cuál es el costo de envío?</a></li>
                <li><a href="#question3">¿Cómo se realizan los envíos?</a></li>
                <li><a href="#question4">¿Cuál es el plazo para realizar un cambio?</a></li>
                <li><a href="#question5">¿Qué debo hacer si el producto no llega en buen estado?</a></li>
              </ul>
            </div>
        <div class="answer-container">
              <h1>frequently <br> asked questions </h1>
               <span></span>
              <article> <a name="question1"></a>
                ...
                <p><strong>EFECTIVO:</strong> debes ingresar tus datos personales, seleccionar la opción de pago por mercado pago y luego seleccionar RAPI PAGO O PAGO FACIL. Finalmente imprimis el cupón y pagas en RAPI PAGO o PAGO FACIL Finalizada la operación, enviar el comprobante de pago a cenit.indumento@gmail.com</p>
              </article>

              <article> <a name="question2"></a>
